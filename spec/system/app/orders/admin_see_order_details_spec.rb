...
describe "Admin visit order details page" do
    it "and see all informations" do
        ...
        Receiver.create!(full_address: "Endereço do destinatário", first_name:"Davide", last_name: "Almeida", registration_code: "123123123", order_id: 1)
